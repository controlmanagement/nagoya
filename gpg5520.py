...
# structure 4: IMGBINCONFIG
# ------------------
class IMGBINCONFIG_dwBinarizationMode(pyinterface.Identifer):
    IFIMG_BINMODE_NORMAL = pIE('IFIMG_BINMODE_NORMAL', lib.IFIMG_BINMODE_NORMAL)
    IFIMG_BINMODE_REVERSAL = pIE('IFIMG_BINMODE_REVERSAL', lib.IFIMG_BINMODE_REVERSAL)
    pass
